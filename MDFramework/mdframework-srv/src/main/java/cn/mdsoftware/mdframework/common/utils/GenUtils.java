...
//		templates.add("templates/common/generator/Mapper.xml.vm");
    ...
    public static String getFileName(String template, String classname,String className, String packageName){
        ...
        if(template.contains("domain.java.vm")){
            return packagePath + File.separator + "bean"+File.separator+"entity" + File.separator + classname + File.separator + className + "DO.java";
        }
        ...
        if(template.contains("Service.java.vm")){
            return packagePath + "service" + File.separator + classname + File.separator + className + "Service.java";
        }
