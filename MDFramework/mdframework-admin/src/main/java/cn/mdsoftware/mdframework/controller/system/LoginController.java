...
import cn.mdsoftware.mdframework.bean.entity.system.MenuDO;
...
import cn.mdsoftware.mdframework.service.system.MenuService;
...
public class LoginController extends BaseController {
	...
	String Index(Model model,HttpSession session) {
		...
		session.setAttribute(cn.mdsoftware.mdframework.common.Constants.SessionKey.FILE_BASE_UPLOAD,fileUploadUrl);
		return "index";
	}
